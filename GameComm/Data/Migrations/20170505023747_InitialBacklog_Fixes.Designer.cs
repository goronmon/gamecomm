...
namespace GameComm.Data.Migrations
{
    ...
    [Migration("20170505023747_InitialBacklog_Fixes")]
    partial class InitialBacklog_Fixes
    {
            ...
            modelBuilder.Entity("GameComm.Models.Game", b =>
                {
                    ...
                    b.Property<long>("ConsoleSystemId");

                    b.Property<int?>("ConsoleSystemId1");
                    ...
                    b.Property<DateTime>("LastModifidDate");
            ...
            modelBuilder.Entity("GameComm.Models.Game", b =>
                {
                    b.HasOne("GameComm.Models.ConsoleSystem", "ConsoleSystem")
                        .WithMany()
                        .HasForeignKey("ConsoleSystemId1");
