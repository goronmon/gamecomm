    ...
    public partial class InitialBacklog : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConsoleSystemId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CompanyId = table.Column<int>(nullable: false),
                    CreateDate = table.Column<DateTime>(nullable: false),
                    IsActive = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsoleSystems", x => x.ConsoleSystemId);
                    table.ForeignKey(
                        name: "FK_ConsoleSystems_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsoleSystemId = table.Column<int>(nullable: true),
                    CreateDate = table.Column<DateTime>(nullable: false),
                    Deleted = table.Column<bool>(nullable: false),
                    FlaggedForApproval = table.Column<bool>(nullable: false),
                    LastMofieidDate = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserGameId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CreateDate = table.Column<DateTime>(nullable: false),
                    GameId = table.Column<long>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsoleSystems_CompanyId",
                table: "ConsoleSystems",
                column: "CompanyId");
